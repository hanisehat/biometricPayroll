...
class Salaries extends CI_Controller
{
	...
	{	
		...
		$data['values'] = $this->SalaryModel->getAllData();
		$data['employees'] = $this->EmployeeModel->getAllData();
		$data['footer'] = $this->footer();
		$data['sidebar']= $this->sidebar();
		$data['header']= $this->header();
		$data['content'] = $this->load->view('salary-list', $data, true);
	...
	{
		$del = $this->SalaryModel->deleteData($id);
		if( $del ) {
	...
	{
		$data = $this->SalaryModel->getDataWhere($id);
	...
	public function add()
	{
		...
		if(is_numeric($id))	 {
			...
			$runQuery = $this->SalaryModel->updateData($data, $id);
		 	...
		 	$runQuery = $this->SalaryModel->insertData($data);
	...
	public function update()
	{
		...
		if(is_numeric($id))	 {
			...
			$runQuery = $this->SalaryModel->updateData($data, $id);
		 	...
		 	$runQuery = $this->SalaryModel->insertData_($data);
