...
class Salaries_full extends CI_Controller
{
	...
	function __construct() 
	{
		...
		$this->load->model('FullSalaryModel');
	...
	{	
		...
		$data['values'] = $this->FullSalaryModel->getAllData();
		$data['employees'] = $this->EmployeeModel->getAllData();
		$data['footer'] = $this->footer();
		$data['sidebar']= $this->sidebar();
		$data['header']= $this->header();
		$data['content'] = $this->load->view('full-salary-list', $data, true);
	...
	{
		$del = $this->FullSalaryModel->deleteData($id);
		if( $del ) {
	...
	{
		$data = $this->FullSalaryModel->getDataWhere($id);
	...
	public function add()
	{
		...
		if(is_numeric($id))	 {
			...
			$runQuery = $this->FullSalaryModel->updateData($data, $id);
		 	...
		 	$runQuery = $this->FullSalaryModel->insertData($data);
	...
	public function update()
	{
		...
		if(is_numeric($id))	 {
			...
			$runQuery = $this->FullSalaryModel->updateData($data, $id);
		 	...
		 	$runQuery = $this->FullSalaryModel->insertData_($data);
