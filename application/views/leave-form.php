...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
                <div class="card">
                    <?php  echo form_open_multipart(base_url().'leaves/leave_new', array('id'=>'form-price', 'class'=>'form-horizontal', 'name'=>'form_employee', 'method'=>'post')) ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Leave Reason / Messge</label>
                                <div class="col-sm-9">
