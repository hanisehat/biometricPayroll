...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
                <div class="card">
                    <?php  echo form_open_multipart(base_url().'reports/report_new', array('id'=>'form-price', 'class'=>'form-horizontal', 'name'=>'form_employee', 'method'=>'post')) ?>
                        ...
                        <div class="card-body">
							...
							<div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Date Start</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="emp_start" name="emp_start" value="<?php if(is_numeric($this->uri->segment(3))) { echo $value->employee_start; } ?>" disabled>
                                </div>
                            </div>
							<div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Salary</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="emp_salary" name="emp_salary" value="<?php if(is_numeric($this->uri->segment(3))) { echo $value->employee_salary; } ?>" disabled>
                                </div>
                            </div>
