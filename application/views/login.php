                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                       <center> <a href="<?php echo base_url('users/admin_login'); ?>" type="button" class="btn btn-success btn-block">Login as Admin</button></a></center>
									   <br>
									   <center><a href="<?php echo base_url('employees/employee_login'); ?>" type="button" class="btn btn-success btn-block">Login as Employee</button></a></center>
                                    </div>
                                </div>
                            </div>
                        </div>
