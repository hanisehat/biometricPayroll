        ...
        <div class="col-12 d-flex no-block align-items-center">
            ...
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="<?php echo base_url('full_attendances/attendance_form'); ?>" type="button" class="btn btn-success">Add New Attendance</button></a></li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <tbody>
                            <?php $i =1;  foreach ($joined_values as $value) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="salary"><a href="<?php echo base_url('/full_attendances/attendance_form/'.$value->attendance_id); ?>">
...
<script>
    ...
    function remover(id) {
        if (confirm("Are you sure?")) {
            ...
            $.post( "<?php echo base_url();?>full_attendances/delete/"+id).done(function( data ) {
