    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<form action="<?php echo base_url('salaries_full/update'); ?>" method="post">
...
<div class="modal fade" id="new_salary" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<form action="<?php echo base_url('salaries_full/add'); ?>" method="post">
	                <div class="form-group row">
...
<script>
    ...
    function remover(id) {
        if (confirm("Are you sure?")) {
            ...
            $.post( "<?php echo base_url();?>salaries_full/delete/"+id).done(function( data ) {
