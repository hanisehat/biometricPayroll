...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
                <div class="card">
                    <?php  echo form_open_multipart(base_url().'claims_emp/add', array('id'=>'form-price', 'class'=>'form-horizontal', 'name'=>'form_claim', 'method'=>'post')) ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="c_name" name="c_name" value="<?php if(is_numeric($this->uri->segment(3))) { echo $value->claim_user; } ?>" >
                                </div>
                            </div>
                            <div class="form-group row">
							...
							<div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control custom-select" style="width: 110%; height:36px;" name="c_status">
